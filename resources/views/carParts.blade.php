...
<body>
    <x-navbar></x-navbar>
        ...
        <script >document.addEventListener("DOMContentLoaded", () => {
            ...
            const cars = [
              { name: "car engien", price: 25, year: 2022 },
              { name: "car fuse ", price: 22, year: 2021 },
              { name: "car oil filter ", price: 45000, year: 2023 },
              { name: "car tier", price: 28, year: 2022 },
              { name: "car pump", price: 55, year: 2023 },
              { name: "car oil", price: 65, year: 2023 },
            ]
    ...
    <div class="min-h-screen grid mx-20 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 p-5 ">
        <!-- part Cards Container -->
        <x-parts-card></x-parts-card>
        <x-parts-card></x-parts-card>
        <x-parts-card></x-parts-card>
    </div>
